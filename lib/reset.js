...
var conString = 'postgres://demoUser:demoPassword@localhost/bartJs';
var pg = require('pg');
var mySql = require('mysql');

//var drop = "DROP TABLE IF EXISTS _compositeOrderLine;DROP TABLE IF EXISTS _compositeOrder;DROP TABLE IF EXISTS deliveryAddress;DROP TABLE IF EXISTS orderLine;DROP TABLE IF EXISTS _order;DROP TABLE IF EXISTS customer;"
...
var createCompositeOrder = "CREATE TABLE _compositeOrder (oCompanyId numeric, orderNo numeric, customerId uuid  REFERENCES customer, PRIMARY KEY (oCompanyId,orderNo));";
var createCompositeOrderLine = "CREATE TABLE _compositeOrderLine (lCompanyId numeric, lOrderNo numeric, lLineNo numeric, product varchar(40), PRIMARY KEY (lCompanyId,lOrderNo, lLineNo));";
